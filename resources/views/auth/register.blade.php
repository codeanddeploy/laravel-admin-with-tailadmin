...
@section('page-description', 'Enter your email and password to register!')
@section('auth-footer-question', 'Already have an account?')
@section('auth-footer-route', route('login'))
@section('auth-footer-button', 'Login')
    ...
    <div>
      ...
      <div x-data="{ showPassword: false }" class="relative">
        ...
        @if ($errors->has('confirm-password'))
          <span class="text-red-600 text-left">{{ $errors->first('confirm-password') }}</span>
        @endif
        <span
          @click="showPassword = !showPassword"
          class="absolute z-30 text-gray-500 -translate-y-1/2 cursor-pointer right-4 top-1/2 dark:text-gray-400"
