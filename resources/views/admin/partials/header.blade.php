  ...
  >
    ...
    >
      ...
      <a href="index.html" class="lg:hidden">
        <img class="dark:hidden" src="admin/default/images/logo/logo.svg" alt="Logo" />
        <img
          class="hidden dark:block"
          src="admin/default/images/logo/logo-dark.svg"
          alt="Logo"
        />
      </a>
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="admin/default/images/user/user-02.jpg"
                      alt="User"
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="admin/default/images/user/user-03.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="admin/default/images/user/user-04.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="admin/default/images/user/user-05.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
